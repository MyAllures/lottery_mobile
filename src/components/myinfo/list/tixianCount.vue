  ...
  <section>
    ...
    <div class="scroll-content has-header">
      ...
      <div class="title flex">
        <div class="item item1">用户名</div>
        <div class="item item2">取款金额</div>
...
<script>
  import { changeStatusNumber, judgeStatus } from '../../../assets/js/payType'
  ...
  export default {
    ...
    methods: {
      getRechergeCount () {
        this.$api.getCashList(this.form).then(res => {
          if (res.code === '000000') {
